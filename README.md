...
- **ZeroTier One** - проприетарная технология реализации VPN-сети, однако одна из немногих (если не единственная), пробивающая защиту фаервола университета. Позволяет подключать до 10 устройств в одну сеть
...
По всем вопросам, чтобы узнать пароль учетной записи обращаться [сюда] (https://t.me/astronom_v_cube)
...
После этого, возможно, придется авторизировать устройство в сети в личном кабинете: TODO
